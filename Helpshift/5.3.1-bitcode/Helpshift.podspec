Pod::Spec.new do |s|
  ...
  s.preserve_paths      = 'helpshift-sdk-ios-v5.3.1/libHelpshift-bitcode.a', 'helpshift-sdk-ios-v5.3.1/HSLocalization/*.lproj', 'helpshift-sdk-ios-v5.3.1/HSThemes/*.plist'
