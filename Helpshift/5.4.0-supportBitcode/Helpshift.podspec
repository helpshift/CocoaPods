Pod::Spec.new do |s|
  s.name                = 'Helpshift'
  s.version             = '5.4.0-supportBitcode'
  ...
  s.preserve_paths      = 'helpshift-sdk-ios-v5.4.0/libSupport-bitcode.a', 'helpshift-sdk-ios-v5.4.0/HSLocalization/*.lproj', 'helpshift-sdk-ios-v5.4.0/HSThemes/*.plist', 'helpshift-sdk-ios-v5.4.0/HelpshiftAssetCatalog.xcassets'
